...
For each brand–persona pair, answers:
  ...
  - Is this persona's mention rate significantly different from the brand's
    ...
    (two-sided binomial test, Bonferroni-corrected for 85 comparisons)
...
N_PERSONAS  = 5
N_BRANDS    = 17   # embedded brands
N_TESTS_BINOM = N_PERSONAS * N_BRANDS  # 85 for Bonferroni correction

...
SYSTEM_PROMPT = """You are a brand extraction assistant. Given a marketing agency \
recommendation response, extract every marketing agency or firm mentioned.

For each brand return:
- brand: the name as it appears in the text
- canonical: normalized display name (e.g. "Refine Labs" → "Refine Labs", \
"Cardinal DM" → "Cardinal Digital Marketing")
...
specialization, results, pricing, transparency, strategy, creative, technology, \
reporting, trust, case-studies, niche-expertise, scale, responsiveness, innovation
- quote: the exact phrase or sentence from the text that supports your classification

Only extract marketing agencies, consultancies, and firms being recommended or evaluated. \
Do NOT extract client brand names, franchise brands, or companies used only as examples \
of a client or case study. Return an empty brands array if none are present."""
